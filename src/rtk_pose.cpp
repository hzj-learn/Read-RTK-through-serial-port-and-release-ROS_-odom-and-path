...
void RtkPose::pub_odom_data()
{
    ...
    _rtk_odom.twist.twist.linear.z = -_xrobot_odom.vz;
    _rtk_odom.twist.twist.angular.x = _xrobot_odom.pitchRate;
    _rtk_odom.twist.twist.angular.y = _xrobot_odom.rollRate;
